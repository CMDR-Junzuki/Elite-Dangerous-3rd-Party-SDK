...
export const blueprints: Record<string, Blueprint> = {
  ...
  ShieldBooster_Explosive: {
    ...
    grades: {
      ...
      "2": {
        ...
        features: {
          explres: [0.07, 0.12],
          kinres: [-0.0175, -0.0175],
          thermres: [-0.0175, -0.0175],
        },
      ...
      "4": {
        ...
        features: {
          explres: [0.17, 0.22],
          kinres: [-0.0325, -0.0325],
          thermres: [-0.0325, -0.0325],
        },
  ...
  CargoRack_IncreasedCapacity: {
    fdname: "CargoRack_IncreasedCapacity",
    grades: {
      "5": {
        components: {},
        features: {
...
export const modifierActions: Record<string, ModifierAction> = {
  ...
  OutfittingFieldType_CargoCapacity: {
    cargo: 1,
  },
};
...
export const specials: Record<string, Special> = {
  ...
  special_feedback_cascade: {
    ...
    description:
      "Rail slug energy charging mechanism, designed to interfere with shield cell operation. Strikes to a target deploying a shield cell will damage the shield cell bank and reduce shield restoration, at the cost of reduced damage from smaller rounds.",
  ...
  special_phasing_sequence: {
    ...
    description:
      "Modulating burst fire system designed to defeat shielding. A small amount of damage is able to bleed through shields and attack the target's hull directly, at the cost of minor damage reduction.",
  ...
  special_powerplant_highcharge: {
    name: "Monstered",
    description:
      "Oversized, reinforced components increase power output at the cost of increased mass.",
    id: 124,
  ...
  special_shieldcell_oversized: {
    name: "Boss Cells",
    description:
      "Oversized cells offer increased cell strength at cost of an increased spin up time.",
    id: 134,
  ...
  special_weapon_rateoffire: {
    name: "Multi-servos",
    description:
      "Additional servomechanisms and controller software allow the weapon to safely fire at an increased rate, at the cost of increased power draw.",
    id: 139,
  ...
  special_hullreinforcement_thermic: {
    name: "Reflective Plating",
    description:
      "Surface coating of advanced formulas designed to reflect and dissipate thermal energy, at the cost of reducing structural integrity benefits.",
    id: 147,
  ...
  special_hullreinforcement_kinetic: {
    name: "Angled Plating",
    description:
      "Custom angling of plates at critical points along the ship's hull make projectile strikes more likely to glance, reducing the impact of kinetic damage at the cost of reducing structural integrity benefits.",
    id: 148,
  ...
  special_hullreinforcement_explosive: {
    name: "Layered Plating",
    description:
      "Layers of advanced inert lining material within the ship's plating absorb and redistribute the force from explosive attacks, reducing damage of this type at the cost of reducing structural integrity benefits.",
    id: 149,
...
export const moduleBlueprintMappings: Record<string, ModuleBlueprintMapping> = {
  am: {
    blueprints: {
      AFM_Shielded: {
        grades: {
          ...
          "4": {
            engineers: ["Lori Jameson", "Petra Olmanova"],
          },
          "5": {
  ...
  bl: {
    blueprints: {
      Weapon_Efficient: {
        grades: {
          "1": {
            engineers: ["Broo Tarquin", "The Dweller", "Mel Brandon"],
          },
          "2": {
            engineers: ["Broo Tarquin", "The Dweller", "Mel Brandon"],
          },
          ...
          "4": {
            engineers: ["Broo Tarquin", "Mel Brandon"],
          },
          "5": {
            engineers: ["Broo Tarquin", "Mel Brandon"],
          },
    ...
    blueprints: {
      ShieldGenerator_Kinetic: {
        grades: {
          ...
          "4": {
            engineers: ["Lei Cheung", "Mel Brandon"],
          },
          "5": {
            engineers: ["Lei Cheung", "Mel Brandon"],
          },
    ...
    blueprints: {
      Weapon_Efficient: {
        grades: {
          ...
          "3": {
            engineers: ["The Sarge", "Marsha Hicks"],
          },
          "4": {
            engineers: ["The Sarge", "Marsha Hicks"],
          },
    ...
    blueprints: {
      CollectionLimpet_LightWeight: {
        grades: {
          ...
          "5": {
            engineers: ["Marsha Hicks", "The Sarge", "Tiana Fortune"],
          },
        },
      },
      CollectionLimpet_Reinforced: {
    ...
    blueprints: {
      FSDinterdictor_Expanded: {
        grades: {
          ...
          "2": {
            engineers: ["Colonel Bris Dekker", "Tiana Fortune", "Mel Brandon"],
          },
          "3": {
            engineers: ["Colonel Bris Dekker", "Tiana Fortune", "Mel Brandon"],
          },
          "4": {
            engineers: ["Colonel Bris Dekker", "Mel Brandon"],
          },
          "5": {
    ...
    blueprints: {
      FuelScoop_Shielded: {
        grades: {
          ...
          "4": {
            engineers: ["Lori Jameson", "Marsha Hicks"],
          },
          "5": {
    ...
    blueprints: {
      FSD_FastBoot: {
        grades: {
          ...
          "4": {
            engineers: ["Elvira Martuuk", "Felicity Farseer", "Mel Brandon"],
          },
          "5": {
            engineers: ["Elvira Martuuk", "Felicity Farseer", "Mel Brandon"],
          },
    ...
    blueprints: {
      Sensor_FastScan: {
        grades: {
          ...
          "4": {
            engineers: ["Tiana Fortune", "Etienne Dorn"],
          },
          "5": {
            engineers: ["Tiana Fortune", "Etienne Dorn"],
          },
  ...
  ls: {
    blueprints: {
      LifeSupport_LightWeight: {
        grades: {
          "1": {
            engineers: ["Bill Turner", "Lori Jameson", "Etienne Dorn"],
          },
          "2": {
            engineers: ["Bill Turner", "Lori Jameson", "Etienne Dorn"],
          },
          ...
          "4": {
            engineers: ["Lori Jameson", "Etienne Dorn"],
          },
          "5": {
            engineers: ["Etienne Dorn", "Etienne Dorn"],
          },
        },
      },
      LifeSupport_Reinforced: {
    ...
    blueprints: {
      Weapon_Efficient: {
        grades: {
          ...
          "4": {
            engineers: ['Tod "The Blaster" McQuinn', "Marsha Hicks"],
          },
          "5": {
            engineers: ['Tod "The Blaster" McQuinn', "Marsha Hicks"],
          },
    ...
    blueprints: {
      Weapon_HighCapacity: {
        grades: {
          ...
          "4": {
            engineers: ["Liz Ryder", "Petra Olmanova"],
          },
          "5": {
            engineers: ["Liz Ryder", "Petra Olmanova"],
          },
    ...
    blueprints: {
      Weapon_HighCapacity: {
        grades: {
          ...
          "4": {
            engineers: ["Juri Ishmaak", "Petra Olmanova"],
          },
          "5": {
            engineers: ["Juri Ishmaak", "Petra Olmanova"],
          },
  ...
  pa: {
    blueprints: {
      Weapon_Efficient: {
        grades: {
          "1": {
            engineers: ["Bill Turner", "Zacariah Nemo", "Etienne Dorn"],
          },
          "2": {
            engineers: ["Bill Turner", "Zacariah Nemo", "Etienne Dorn"],
          },
          "3": {
            engineers: ["Bill Turner", "Etienne Dorn"],
          },
          "4": {
            engineers: ["Bill Turner", "Etienne Dorn"],
          },
    ...
    blueprints: {
      PowerDistributor_HighFrequency: {
        grades: {
          ...
          "4": {
            engineers: ["The Dweller", "Etienne Dorn"],
          },
          "5": {
            engineers: ["The Dweller", "Etienne Dorn"],
          },
    ...
    blueprints: {
      PowerPlant_Armoured: {
        grades: {
          ...
          "2": {
            engineers: ["Hera Tani", "Marco Qwent", "Etienne Dorn"],
          },
          "3": {
            engineers: ["Hera Tani", "Marco Qwent", "Etienne Dorn"],
          },
          ...
          "5": {
            engineers: ["Hera Tani", "Etienne Dorn"],
          },
        },
      },
      PowerPlant_Stealth: {
    ...
    blueprints: {
      Weapon_HighCapacity: {
        grades: {
          ...
          "4": {
            engineers: ['Tod "The Blaster" McQuinn', "Etienne Dorn"],
          },
          "5": {
            engineers: ['Tod "The Blaster" McQuinn', "Etienne Dorn"],
          },
    ...
    blueprints: {
      ShieldBooster_Explosive: {
        grades: {
          ...
          "2": {
            engineers: ["Didi Vatermann", "Lei Cheung", "Mel Brandon"],
          },
          "3": {
            engineers: ["Didi Vatermann", "Lei Cheung", "Mel Brandon"],
          },
          "4": {
            engineers: ["Didi Vatermann", "Mel Brandon"],
          },
          "5": {
            engineers: ["Didi Vatermann", "Mel Brandon"],
          },
  ...
  scb: {
    blueprints: {
      ShieldCellBank_Rapid: {
        grades: {
          "1": {
            engineers: ["Elvira Martuuk", "Lori Jameson", "Mel Brandon"],
          },
          "2": {
            engineers: ["Lori Jameson", "Mel Brandon"],
          },
          "3": {
            engineers: ["Lori Jameson", "Mel Brandon"],
          },
    ...
    blueprints: {
      Engine_Dirty: {
        grades: {
          ...
          "4": {
            engineers: ["Professor Palin", "Mel Brandon", "Chloe Sedesi"],
          },
          "5": {
            engineers: ["Professor Palin", "Mel Brandon", "Chloe Sedesi"],
          },
